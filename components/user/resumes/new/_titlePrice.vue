<template>
    <div class="title-price">
        <div class="page-title">
            ...
            <p v-if="!canFill">
                نگـارش رزومه از زمان ثبت سفـارش تا تحویل، هفت تا ده روز کـاری زمان
                می‌بـــــرد
            </p>
...
برای دسترسی به این قسمت باید ابتدا
        ...
        <div class="resume-price">
            <div class="text" v-if="$auth.user.type == 2">
                <p>رایگان</p>
                <span>مبلغ نگارش رزومه</span>
            </div>
            <div class="text" v-else>
                <p v-if="resumelang && resumelang.toString() === 'دو زبانه'">{{ prices.resume_bi | numberFilter }}</p>
                <p v-else>{{ prices.resume | numberFilter }}</p>
                <span>مبلغ نگارش رزومه (ریال)</span>
            </div>
            <div class="icon">
                <svg
