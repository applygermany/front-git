    ...
    <div class="header-expert__top">
        ...
        <div class="chat-messages-dark">
            ...
            <a @click="openSide('note')" class="messages" style='position: relative;'>
                <div class='newmew' v-if='notifUnreadCount > 0'></div>
                <svg
                        class="uk-svg"
                        height="29"
                        viewBox="0 0 29 29"
            ...
            <a @click="openSide('list')" v-if="this.$auth.user.level != 7" class="chat" style='position: relative;'>
              <div class='newmew' v-if='unreadCount > 0'></div>
                <svg
                        class="uk-svg"
                        height="45"
                        viewBox="0 0 45 45"
    ...
    export default {
        ...
        methods: {
            ...
            async changeDarkMode() {
                ...
                await this.$axios.get("v1/expert/changeDarkMode");
            },
            openSide(pos) {
                if (this.chatSide == "note" && pos == "note") {
                    this.$store.commit("expert/Set_ChatSide", "");
                ...
                this.$store.commit("expert/Set_ChatSide", pos);
            },
        },
    };
</script>
