            ...
            <div id="resume">
                ...
                <div>
                    ...
                    <div class="educate-info">
                        ...
                        <div>
                            <SoftwareKnowledge :key="index" :SoftwareKnowledge="SoftwareKnowledge"
                ...
                <aside>
                    <div>
                        ...
                        <BR/>
                        <p v-if="resume.user_comment != null">
                            <span>توضیحات کاربر : </span>
                            <span>{{ resume.user_comment }}</span>
                        </p>
                        <br/>
...
import Education from "@/components/writer/resume/education.vue";
import Language from "@/components/writer/resume/language.vue";
import Works from "@/components/writer/resume/works.vue";
import SoftwareKnowledge from "@/components/writer/resume/softwareKnowledge.vue";
import Courses from "@/components/writer/resume/courses.vue";
import Researchs from "@/components/writer/resume/researchs.vue";
import Hobbies from "@/components/writer/resume/hobbies.vue";
...
export default {
    ...
    async asyncData({params, $auth, $axios, redirect}) {
        ...
        const {data} = await $axios.get("v1/writer/getResume/" + params.id);
        return {
            resume: data.resume,
        };
    },
