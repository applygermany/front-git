            ...
            <div id="resume">
                        ...
                        <div>
                            ...
                            <div v-else>
                                <University :key="index" :university="university"
                                            v-for="(university, index) in motivation.universities"/>
                            </div>
                ...
                <aside>
                    <div>
                        ...
                        <br/>
                        <p v-if="motivation.user_comment != null">
                            <span>توضیحات کاربر : </span>
                            <span>{{motivation.user_comment}}</span>
                        </p>
                        <br/>
...
import University from "@/components/writer/motivation/university.vue"
...
export default {
    ...
    async asyncData({params, $auth, $axios, redirect}) {
        ...
        const {data} = await $axios.get("v1/writer/getMotivation/" + params.id);
        return {
