...
export default {
  ...
  async asyncData({params, store, $auth, $axios, redirect}) {
    ...
    // if($auth.user.type == 1 && store.getters['telSupports/openInTelSupport'] == false){
    ...
    store.commit("telSupports/SET_ExpertId", params.id);
    store.commit("telSupports/SET_Expert", data.expert);
    store.commit("telSupports/SET_Weeks", data.weeks);
    store.commit("telSupports/SET_Days", data.days);
    store.commit("telSupports/SET_Months", data.months);
    store.commit(
        "telSupports/SET_FirstDayTelSupports2",
        data.firstDayTelSupports2
    );
    store.commit(
        "telSupports/SET_SecondDayTelSupports2",
        data.secondDayTelSupports2
    );
    store.commit(
        "telSupports/SET_ThirdDayTelSupports2",
        data.thirdDayTelSupports2
    );
    store.commit(
        "telSupports/SET_FourthDayTelSupports2",
        data.fourthDayTelSupports2
    );
    store.commit(
        "telSupports/SET_FifthDayTelSupports2",
        data.fifthDayTelSupports2
    );
    store.commit(
        "telSupports/SET_SixthDayTelSupports2",
        data.sixthDayTelSupports2
    );

    store.commit(
        "telSupports/SET_FirstDayTelSupports1",
        data.firstDayTelSupports1
    );
    store.commit(
        "telSupports/SET_SecondDayTelSupports1",
        data.secondDayTelSupports1
    );
    store.commit(
        "telSupports/SET_ThirdDayTelSupports1",
        data.thirdDayTelSupports1
    );
    store.commit(
        "telSupports/SET_FourthDayTelSupports1",
        data.fourthDayTelSupports1
    );
    store.commit(
        "telSupports/SET_FifthDayTelSupports1",
        data.fifthDayTelSupports1
    );
    store.commit(
        "telSupports/SET_SixthDayTelSupports1",
        data.sixthDayTelSupports1
    );
    store.commit(
        "telSupports/SET_SeventhDayTelSupports1",
        data.seventhDayTelSupports1
    );

    store.commit(
        "telSupports/SET_FirstDayTelSupports",
        data.firstDayTelSupports
    );
    store.commit(
        "telSupports/SET_SecondDayTelSupports",
        data.secondDayTelSupports
    );
    store.commit(
        "telSupports/SET_ThirdDayTelSupports",
        data.thirdDayTelSupports
    );
    store.commit(
        "telSupports/SET_FourthDayTelSupports",
        data.fourthDayTelSupports
    );
    store.commit(
        "telSupports/SET_FifthDayTelSupports",
        data.fifthDayTelSupports
    );
    store.commit(
        "telSupports/SET_SixthDayTelSupports",
        data.sixthDayTelSupports
    );
    store.commit(
        "telSupports/SET_SeventhDayTelSupports",
        data.seventhDayTelSupports
    );
